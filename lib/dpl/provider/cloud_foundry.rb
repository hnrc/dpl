  ...
  class Provider
    class CloudFoundry < Provider
      ...
      def initial_go_tools_install
        context.shell '[[ $TRAVIS_OS_NAME = "linux" ]] && rel="linux64-binary" || rel="macosx64"; wget \'https://cli.run.pivotal.io/stable?release=${rel}&source=github\' -qO cf.tgz && tar -zxvf cf.tgz && rm cf.tgz'
      end
